...
from px4_msgs.msg import VehicleLocalPosition, VehicleAttitude   # 新增 VehicleAttitude
...
class DetectionWorldConverter(Node):
    ...
    坐标转换全部委托给 MonocularPlaneMeasurer。
    """
